...
<div class="container">
    <div class="row justify-content-center">
        ...
        <div class="col-md-8 py-4 d-flex flex-column">
            <h1 class="h3 mb-3 font-weight-normal font-weight-bold text-center">Create Products</h1>
            <form method="POST" action="{{route('products.store')}}" enctype="multipart/form-data">
                ...
                <div class="form-group d-flex flex-column align-items-center">
                    ...
                    <input id="price" type="text" class="form-control" name="price" placeholder="Price" required  autofocus>
                </div>
                <div class="form-group d-flex flex-column align-items-center">
